interface PersonaCardProps {
  ...
  export const PersonaCard = ({
    ...
    return (
      <div className="flex flex-col md:grid md:grid-cols-3 md:gap-8 p-8 bg-white rounded-lg max-w-4xl mx-auto mt-6">
        <div className="col-span-1 flex flex-col items-center mb-6 md:mb-0 bg-orange-200 rounded-md p-2">
          <img
            src={image}
            alt={name}
            className="w-40 rounded-md mb-6 object-cover shadow-md h-2/3"
          />
          <div className="h-1/3">
